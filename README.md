...
This project is inspired by the idea of living on a human's potential future habitat - Mars!  
...
The mission is to find the following "treasures" - more like necessary equipment - in order to survive on Mars:  
...
The Mars environment is built with the following 13 free models from Unity Asset Store:   
